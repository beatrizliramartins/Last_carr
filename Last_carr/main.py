...
botao_inserir = Button(frameMeio, image=img_add, command=inserir, compound=LEFT, anchor=NW, text="   Adicionar".upper(), width=95,
...
botao_ver = Button(frameMeio, image=img_item, compound=LEFT, anchor=NW, text="   Ver item".upper(), width=95,
                   overrelief=RIDGE, font=('ivy 8'), bg=co1, fg=co0)

...
from view import inserir_form, ver_form, ver_iten, ver_item
...
def inserir():
    ...
    valor = e_valor.get()
    serie = e_serial.get()
    imagem_string = "example_string_value"
...
app_img = Image.open('carros.png')
app_img = app_img.resize((45, 45))
app_img = ImageTk.PhotoImage(app_img)

app_logo = Label(frameCima, image=app_img, text=" Last Car LTDA ", width=900, compound=LEFT, relief=RAISED, anchor=NW,
                 font=('Verdana 20 bold'), bg=co2, fg=co1)
...
botao_inserir = Button(frameMeio, image=img_add, command=inserir, compound=LEFT, anchor=NW, text="   Adicionar".upper(),
                       width=95,
...
botao_carregar = Button(frameMeio, command=escolher_imagem, compound=CENTER, anchor=CENTER, text="carregar".upper(),
...
botao_deletar = Button(frameMeio, image=img_delete, compound=LEFT, anchor=NW, text="   Deletar".upper(), width=95,
                       overrelief=RIDGE, font=('ivy 8'), bg=co1, fg=co0)
...
botao_ver = Button(frameMeio, image=img_item, command=ver_imagem, compound=LEFT, anchor=NW, text="   Ver item".upper(),
                   width=95,
                   overrelief=RIDGE, font=('ivy 8'), bg=co1, fg=co0)
...
l_valor_total = Label(frameMeio, text='  Valor Total de todos os itens  ', anchor=NW, font=('Ivy 10 bold'), bg=co7,
                      fg=co1)
...
def mostrar():
    ...
    tabela_head = ['Item', 'Nome', 'Ano', 'Descrição', 'Marca', 'Data da compra', 'Valor da compra', 'Número de série']
